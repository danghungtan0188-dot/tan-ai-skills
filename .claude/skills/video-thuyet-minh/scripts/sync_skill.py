#!/usr/bin/env python3
"""Dong bo skills/video-thuyet-minh (nguon chuan) sang
.agents/skills/video-thuyet-minh va .claude/skills/video-thuyet-minh
...
SOURCE_DIR = SCRIPT_DIR.parent  # skills/video-thuyet-minh
REPO_ROOT = SOURCE_DIR.parent.parent  # thu muc goc repo

SKILL_NAME = "video-thuyet-minh"
