#!/usr/bin/env python3
"""Dong bo skills/dung-video-su-kien (nguon chuan) sang
.agents/skills/dung-video-su-kien va .claude/skills/dung-video-su-kien
...
SOURCE_DIR = SCRIPT_DIR.parent  # skills/dung-video-su-kien
REPO_ROOT = SOURCE_DIR.parent.parent  # thu muc goc repo

SKILL_NAME = "dung-video-su-kien"
