#!/usr/bin/env python3
"""Dong bo skills/bien-tap-video (nguon chuan) sang
.agents/skills/bien-tap-video va .claude/skills/bien-tap-video
...
SOURCE_DIR = SCRIPT_DIR.parent  # skills/bien-tap-video
REPO_ROOT = SOURCE_DIR.parent.parent  # thu muc goc repo

SKILL_NAME = "bien-tap-video"
