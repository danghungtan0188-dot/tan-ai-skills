#!/usr/bin/env python3
"""Dong bo skills/hieu-ung-video (nguon chuan) sang
.agents/skills/hieu-ung-video va .claude/skills/hieu-ung-video
...
SOURCE_DIR = SCRIPT_DIR.parent  # skills/hieu-ung-video
REPO_ROOT = SOURCE_DIR.parent.parent  # thu muc goc repo

SKILL_NAME = "hieu-ung-video"
